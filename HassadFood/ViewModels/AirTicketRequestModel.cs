...
{
    public class AirTicketRequestModel : ViewModelBase
    {
        Page _page;
        IUserDetails userDetails;
        public AirTicketRequestModel(Page page) : base(page)
        {
        ...
        async void ExecuteSubmitCommand()
        {
            ...
            AirTicketServiceRequest request = new AirTicketServiceRequest
            {
            ...
            try
            {
                var result = await userDetails.PutAirTicketRequest(request);
                if (result)
                {
