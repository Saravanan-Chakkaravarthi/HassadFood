...
{
    public partial class EducationAllowanceRequest : ContentPage
    {
        EducationAllowanceRequestModel viewModel;
        public EducationAllowanceRequest()
        {
            InitializeComponent();
            ...
            BindingContext = viewModel = new EducationAllowanceRequestModel(this);
        }
